// TODO: Convert the given array to string at runtime and use that instead
pub(super) const ASCII_95_TABLE: [u8; 95] = [
...
pub(super) const COMMON_RANGE: [u8; 77] = [
...
pub(super) const NO_SPECIAL_RANGE: [u8; 62] = [

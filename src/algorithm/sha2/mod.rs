...
mod test {
    ...
    fn sha224() {
        ...
        let mut sha224 = Sha224::from(TEST);
        sha224.run();
    ...
    fn sha256() {
        ...
        let mut sha256 = Sha256::from(TEST);
        sha256.run();
    ...
    fn sha384() {
        ...
        let mut sha384 = Sha384::from(TEST);
        sha384.run();
    ...
    fn sha512() {
        ...
        let mut sha512 = Sha512::from(TEST);
        sha512.run();
    ...
    fn sha512_224() {
        ...
        let mut sha512_224 = Sha512_224::from(TEST);
        sha512_224.run();
    ...
    fn sha512_256() {
        ...
        let mut sha512_256 = Sha512_256::from(TEST);
        sha512_256.run();
